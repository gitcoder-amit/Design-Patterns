...
Just in compiler is improved version of Interpreter because Interpreter after converting one line into machine code waits for OS to process another line.
'''